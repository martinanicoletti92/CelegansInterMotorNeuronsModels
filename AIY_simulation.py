...
names=numpy.array("leak, slo1iso,kqt1,egl19,slo1egl19,nca,irk,eleak,cm".split(','))
...
best_iv_SHL1=numpy.array(list(best_results[2]))

# fname4="AIY_simulated_current_SHL1.txt"
# fname5="AIY_simulated_time_SHL1.txt"
# fname6="AIY_simulated_IV_SS_SHL1.txt"
# fname7="AIY_IV_simulated_PEAK_SHL1.txt"

# path='E:\RIM_MARCH_2021\AIY_FINAL_MODEL_4'
...
# numpy.savetxt(path7, best_iv_SHL1, delimiter=", " , fmt="%s")



# gbest=numpy.numpy.loadtxt('E:\MNicoletti\RIM_MARCH_2021\AIY_T3\AIY_T3_gbest_Scm2.txt')
...
# fname8='AIY_CC_simulated_voltage_SHL1.txt'
# fname9='AIY_CC_simulated_time_SHL1.txt'
...
iv_plot=pyplot.plot(v,best_iv_SHL1,color='red',marker='o',markersize=15,label='optimized-peaks')
pyplot.xlabel('V [mV]')
pyplot.ylabel('I [pA]')
pyplot.xlim(-130,60)
fig.legend(loc=5)
